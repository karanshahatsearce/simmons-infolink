...
PREAMBLE = (
    "Given the conversation between a user and a Simmons Bank assistant and some search results, "
    "create a final answer for the assistant that can provide insights from Simmons Bank Quarterly reports. "
    ...
    "The assistant's answer should be more than 50 sentences, and about 1000 words. "
    "The assistant's answer should have at least 2 paragraphs for summary and a list of details. "
    "DO NOT TRY TO BOLD ANYTHING. "
    "For bullet points, use '-' and nothing else, no asterisk. "
)
